...
@section('content')
    <div class="card mt-6">
        <div class="card-header flex flex-row justify-between">
            <h1 class="h6">Inschrijving Toevoegen</h1>
        </div>
        ...
        <div class="card-body grid grid-cols-1 gap-6 lg:grid-cols-1">
            <div class="p-4">
                <form id="form" class="shadow-md rounded-lg px-8 pt-6 pb-8 mb-4"
                      action="{{ route('admin.enrollments.store') }}" method="POST">
                    @csrf
                    <div class="mb-4">
                        ...
                        <label class="block text-sm">
                            ...
                            focus:outline-none focus:shadow-outline-purple form-select"
                                ...
                                @foreach($crebos as $crebo)
                                    <option value="{{ $crebo->id }}" {{ old('crebo_id') == $crebo->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-4">
                        <label class="block text-sm">
                            ...
                            focus:outline-none focus:shadow-outline-purple form-input"
                                   name="enrollmentdate" value="{{ old('enrollmentdate') }}" type="date" required/>
                        </label>
                    </div>
