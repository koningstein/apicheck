        ...
        <div class="card-body grid grid-cols-1 gap-6 lg:grid-cols-1">
            <div class="p-4">
                <form id="form" class="shadow-md rounded-lg px-8 pt-6 pb-8 mb-4"
                      action="{{ route('admin.students.destroy', ['student' => $student->id]) }}" method="POST">
                    @method('DELETE')
                    @csrf
                    <div class="mb-4">
                        <label class="block text-sm">
                            ...
                            focus:outline-none focus:shadow-outline-purple form-input"
                                   name="eduarteid" value="{{ $student->eduarteid }}" type="text" disabled/>
                        </label>
                    </div>
                    ...
                    <div class="mb-4">
                        <label class="block text-sm">
                            ...
                            <input class="bg-gray-200 block rounded w-full p-2 mt-1 focus:border-purple-400
                            focus:outline-none focus:shadow-outline-purple form-input"
                                   name="canvasid" value="{{ $student->canvasid }}" type="text" disabled/>
                        </label>
                    </div>
                    ...
                    <div class="mb-4 flex items-center">
                        <label class="inline-flex items-center text-sm">
                            <input type="checkbox" name="isactive" value="1"
                                   ...
                                   class="text-purple-600 form-checkbox focus:border-purple-400 focus:outline-none focus:shadow-outline-purple" disabled>
                    ...
                    <div class="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 mb-4" role="alert">
                        ...
                        <p>Weet je zeker dat je deze student wilt verwijderen? Deze actie kan niet ongedaan worden gemaakt.</p>
                        @if($student->enrollments->count() > 0)
                            <p class="mt-2 font-bold">Waarschuwing: Deze student heeft {{ $student->enrollments->count() }} inschrijving(en). Door de student te verwijderen, worden ook alle gekoppelde inschrijvingen verwijderd!</p>
                        @endif
                    </div>
