                ...
                <form id="form" class="shadow-md rounded-lg px-8 pt-6 pb-8 mb-4"
                    ...
                    <div class="mb-4">
                        <label class="block text-sm">
                            ...
                            <input class="bg-gray-200 block rounded w-full p-2 mt-1 focus:border-purple-400
                            focus:outline-none focus:shadow-outline-purple form-input"
                                   name="startdate" value="{{ old('startdate', $cohort->startdate ? date('Y-m-d', strtotime($cohort->startdate)) : '') }}" type="date" required/>
                        </label>
                    </div>
                    ...
                    <div class="mb-4">
                        <label class="block text-sm">
                            ...
                            <input class="bg-gray-200 block rounded w-full p-2 mt-1 focus:border-purple-400
                            focus:outline-none focus:shadow-outline-purple form-input"
                                   name="enddate" value="{{ old('enddate', $cohort->enddate ? date('Y-m-d', strtotime($cohort->enddate)) : '') }}" type="date"/>
                        </label>
